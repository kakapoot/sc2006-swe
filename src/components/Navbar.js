            ...
            <nav className="px-sm-auto vh-100 sticky-top d-flex flex-column align-items-center">
                ...
                <Link to="/">
                    <span className="my-5 d-flex align-items-center gap-3 text-light">
                        ...
                        <span className="fs-3 d-sm-inline d-none"><strong>Study</strong>Kakis</span>
                    </span>
                </Link>

                {/* Menu links */}
                <ul id="menu" className="w-100 gap-2 nav d-flex flex-column align-items-stretch text-light">
                    <NavLink to="/my_groups" className={currentTab}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="text-secondary bi bi-people" viewBox="0 0 16 16">
                    ...
                    <NavLink to="/find_groups" className={currentTab}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="text-secondary bi bi-search-heart" viewBox="0 0 16 16">
                    ...
                    <NavLink to="/study_areas" className={currentTab}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="text-secondary bi bi-map" viewBox="0 0 16 16">
                    ...
                    <NavLink to={`/user/${username}`} className={currentTab}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="text-secondary bi bi-person-vcard" viewBox="0 0 16 16">
                ...
                <div className="mt-auto mb-4 w-100 gap-2 nav d-flex flex-column align-items-stretch text-light">
                    {/* Log Out */}
                    <div onClick={logout} className="text-danger p-3 btn btn-primary gap-3 d-flex align-items-center">
