...
export const useTags = () => {
    ...
    const { data, error, isLoading } = useSWR(`${process.env.REACT_APP_SERVER_URL}/get_tags`, fetcher)
...
export const useUserRights = (username, groupId) => {
    ...
    const { data, error, isLoading, mutate } = useSWR(`${process.env.REACT_APP_SERVER_URL}/get_user_rights/${username}?groupId=${groupId}`, fetcher)
...
export const useGroup = (groupId) => {
    ...
    const { data, error, isLoading, mutate } = useSWR(`${process.env.REACT_APP_SERVER_URL}/get_group/${groupId}`, fetcher)
...
export const useUserProfile = (username) => {
    ...
    const { data, error, isLoading, mutate } = useSWR(`${process.env.REACT_APP_SERVER_URL}/get_user/${username}`, fetcher)
...
export const useGroupMembers = (groupId) => {
    ...
    const { data, error, isLoading, mutate } = useSWR(`${process.env.REACT_APP_SERVER_URL}/get_group_members/${groupId}`, fetcher)
...
export const useUserGroups = (username) => {
    ...
    const { data, error, isLoading, mutate } = useSWR(`${process.env.REACT_APP_SERVER_URL}/get_my_groups/${username}`, fetcher)
...
export const useStudyAreas = () => {
    ...
    const { data, error, isLoading, mutate } = useSWR(`${process.env.REACT_APP_SERVER_URL}/get_available_places`, fetcher)
