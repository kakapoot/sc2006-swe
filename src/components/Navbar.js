...
export function Navbar() {
    return (
        <nav className="px-5 bg-primary sticky-top col-sm-auto d-flex flex-column">
            {/* Logo */}
            <span className="my-5 d-flex align-items-center gap-3 text-light">
                ...
                <Link to="/">
                    <span className="fs-3 text-light"><strong>Study</strong>Kakis</span>
                </Link>
            </span>
            ...
            <ul id="menu" className="gap-2 nav d-flex flex-column align-items-stretch text-light">
                ...
                <NavLink to="/study_areas" className={currentTab}>
                    ...
                    <li>Study Areas</li></NavLink>
                <NavLink to="/profile" className={currentTab}>
